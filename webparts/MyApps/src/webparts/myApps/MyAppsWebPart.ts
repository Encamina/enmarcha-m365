...
import { IMyAppsProps } from "./components/interface/IMyAppsProps";
  ...
  public render(): void {
    const element: React.ReactElement<IMyAppsProps> = React.createElement(
      MyApps,
      {
        ...
        mainColor: this.properties.mainColor || "#FFFF00",
      }
    );
      ...
      pages: [
        {
          ...
          groups: [
            ...
            {
              groupName: strings.Config,
              groupFields: [
                PropertyPaneTextField("mainColor", {
